<template>
  <div class="revision">
    ...
    <div v-if="!revisionStarted">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 md:mt-8 ">
    ...
    <div v-if="revisionStarted">
      ...
      <div v-else class="bg-white rounded-lg shadow-md p-8 mx-auto max-w-xl">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-center">
          ...
          <button class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded mb-4 sm:mr-4" @click="resetRevision">Réviser à nouveau</button>
          <button class="bg-yellow-400 hover:bg-yellow-600 text-white font-bold py-2 px-4 rounded mb-4 sm:mr-4" @click="scheduleDailyReminder">Planifier un rappel quotidien</button>
